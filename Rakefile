...
begin
  ...
  Jeweler::Tasks.new do |gemspec|
    gemspec.name        = "brodock-visage-app"
    ...
    gemspec.email       = "brodock@gmail.com"
    gemspec.homepage    = "http://visage-app.com/"
    gemspec.authors     = ["Lindsay Holmwood", "Gabriel Mazetto"]
    
    gemspec.required_ruby_version = '>= 1.9.3'

    gemspec.add_dependency "sinatra", "~> 1.3.2"
    gemspec.add_dependency "tilt", "~> 1.3"
    gemspec.add_dependency "haml", "~> 3.1.4"
    gemspec.add_dependency "errand", "= 0.7.3"
    gemspec.add_dependency "yajl-ruby", "~> 1.1.0"
    gemspec.add_dependency "librrd", "~> 1.0.2"
  end
rescue LoadError
